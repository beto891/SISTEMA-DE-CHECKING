...
# 1. Executa o script de inicialização do banco de dados (Usando a CLI do Flask, que é mais estável)
# O comando 'flask' encontra e executa a função inicializar_banco no contexto da aplicação.
